...
package ink.flybird.anifly.ui.theme.palette.dynamic
...
import ink.flybird.anifly.ui.theme.palette.TonalPalettes.Companion.getSystemTonalPalettes
import ink.flybird.anifly.ui.theme.palette.TonalPalettes.Companion.toTonalPalettes
import ink.flybird.anifly.ui.theme.palette.safeHexToColor
...
fun extractTonalPalettesFromUserWallpaper(): List<TonalPalettes> {
    ...
    val customPrimaryColor = AFSetting.defaultColor
